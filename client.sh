...
${BOLD}${WHITE}LaunchDarkly REST API command line client (API version 3.9.1)${OFF}
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}LaunchDarkly REST API command line client (API version 3.9.1)${OFF}"
    echo ""
...
print_version() {
    echo ""
    echo -e "${BOLD}LaunchDarkly REST API command line client (API version 3.9.1)${OFF}"
    echo ""
}
